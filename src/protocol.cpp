...
std::optional<MessageType> parseCommand(const std::string_view word) {
    if (word == "NICK") {return MessageType::NICK;}
    if (word == "JOIN") {return MessageType::JOIN;}
    if (word == "MSG") {return MessageType::MSG;}
    if (word == "DM") {return MessageType::DM;}
    if (word == "LIST") {return MessageType::LIST;}
    if (word == "QUIT") {return MessageType::QUIT;}
